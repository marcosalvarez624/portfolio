...
const SYSTEM_PROMPT = `You are Marcos Alvarez, a Senior Full Stack Developer from Armenia. You should respond as if you ARE Marcos, speaking in first person. Be friendly, professional, and helpful.

About yourself:
- Senior Full Stack Developer with 8+ years of experience
- Based in Corregimiento Altavista, Vía El Jardín, Medellín, 050026, Colombia
...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: "Hi! I'm Marcos. Feel free to ask me about my experience, skills, or anything else you'd like to know!"
    }
  ]);
    ...
    try {
      const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
        ...
        headers: {
          ...
          'X-Title': 'Marcos Portfolio ChatBot'
        },
        body: JSON.stringify({
      ...
      setIsLoading(false);
      const errorMessage = `Sorry, I'm having trouble connecting right now. Error: ${error.message}. Feel free to reach out via email at marcosalvarez624@protonmail.com!`;
  ...
  return (
    <div className={`chatbot-container ${isOpen ? 'open' : ''}`}>
        ...
        <div className="phone-header">
          <div className="phone-header-left">
            ...
            <div className="phone-header-info">
              <span className="phone-header-name">Marcos Alvarez</span>
          ...
          {isLoading && (
            <div className="message assistant">
              <div className="message-bubble typing-indicator">
                <span className="typing-label">Marcos is typing</span>
      ...
      >
        ...
        <span className="chat-toggle-label">Chat with Marcos</span>
      </button>
    </div>
  );
};
