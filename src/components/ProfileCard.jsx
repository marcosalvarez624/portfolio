    ...
    <section className="profile-card card">
      ...
      <div className="profile-photo-wrapper">
        <div className="profile-photo">
          <img src="/image/profile.jpg" alt="Marcos Alvarez" />
        </div>
      </div>
      ...
      <div className="profile-content">
        <div className="profile-main">
          <div className="profile-info">
            <h1 className="profile-name">Marcos Alvarez</h1>
            <p className="profile-headline">
              Senior Full Stack Developer | Web | Mobile | AI/ML | Blockchain | 8+ Years Experience
            </p>
            <p className="profile-location">
              Corregimiento Altavista, Vía El Jardín, Medellín, 050026, Colombia
          ...
          <div className="profile-company">
            <a href="https://www.totvs.com/" target="_blank" rel="noopener noreferrer" className="company-item">
              ...
              <span className="company-name">TOTVS</span>
            </a>
            <a href="https://am.linkedin.com/school/yerevan-state-university/" target="_blank" rel="noopener noreferrer" className="company-item">
              <div className="company-logo">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="32" height="32">
              ...
              <span className="company-name">Yerevan State University</span>
            </a>
          </div>
        </div>
